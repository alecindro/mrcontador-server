...
public class TestPdfUnicred {
	...
	public void testBB() throws Exception {
			...
			String folder1 = "C:\\Users\\alecindro.castilho\\Documents\\study\\mrcontador\\docs\\avb kretzer\\comprovantes-1-mesclado.pdf";
			...
			Agenciabancaria agencia = agenciaService.findOne(15L).get();
			Optional<Parceiro> parceiro = parceiroService.findOne(5L);
