...
public class ExcelParserTest extends TikaTest {
	    ...
	    public void testExcelParser() throws Exception {
	        try (InputStream input  = new FileInputStream(new File("/home/alecindro/Documents/drcontabil/docs/pl_contas.xls"))) {
	  ...
	  public void print(String content, Metadata metadata) {
...
//	        assertContains("<a href=\"http://tika.apache.org/1.12/gettingstarted.html\">", xml);
	    ...
	    @Test
	    public void textXml() throws IOException, SAXException, TikaException {
	    	InputStream in = new FileInputStream(new File("/home/alecindro/Documents/drcontabil/docs/pl_contas.xls"));
	    	Metadata metadata = new Metadata();
	    	XMLResult result = this.execXml(in, new AutoDetectParser(), metadata, new ParseContext());
	    	print(result.xml, metadata);
	    }

	    
	    private XMLResult execXml(InputStream input, AutoDetectParser parser, Metadata metadata,
