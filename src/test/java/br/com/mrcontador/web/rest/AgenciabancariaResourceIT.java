...
public class AgenciabancariaResourceIT {
    ...
    private static final String DEFAULT_AGE_AGENCIA = "AAAAAA";
    private static final String UPDATED_AGE_AGENCIA = "BBBBBB";
    ...
    public void createAgenciabancaria() throws Exception {
        ...
        assertThat(testAgenciabancaria.getBan_codigobancario()).isEqualTo(DEFAULT_BAN_CODIGOBANCARIO);
    }
    ...
    public void checkBan_codigobancarioIsRequired() throws Exception {
        int databaseSizeBeforeTest = agenciabancariaRepository.findAll().size();
        // set the field null
        agenciabancaria.setBan_codigobancario(null);

        // Create the Agenciabancaria, which fails.
        AgenciabancariaDTO agenciabancariaDTO = agenciabancariaMapper.toDto(agenciabancaria);
        ...
        List<Agenciabancaria> agenciabancariaList = agenciabancariaRepository.findAll();
        assertThat(agenciabancariaList).hasSize(databaseSizeBeforeTest);
    }
    ...
    @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioIsEqualToSomething() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario equals to DEFAULT_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.equals=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the agenciabancariaList where ban_codigobancario equals to UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.equals=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioIsNotEqualToSomething() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario not equals to DEFAULT_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.notEquals=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the agenciabancariaList where ban_codigobancario not equals to UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.notEquals=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioIsInShouldWork() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario in DEFAULT_BAN_CODIGOBANCARIO or UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.in=" + DEFAULT_BAN_CODIGOBANCARIO + "," + UPDATED_BAN_CODIGOBANCARIO);

        // Get all the agenciabancariaList where ban_codigobancario equals to UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.in=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioIsNullOrNotNull() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario is not null
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.specified=true");

        // Get all the agenciabancariaList where ban_codigobancario is null
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.specified=false");
    }
                @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioContainsSomething() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario contains DEFAULT_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.contains=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the agenciabancariaList where ban_codigobancario contains UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.contains=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllAgenciabancariasByBan_codigobancarioNotContainsSomething() throws Exception {
        // Initialize the database
        agenciabancariaRepository.saveAndFlush(agenciabancaria);

        // Get all the agenciabancariaList where ban_codigobancario does not contain DEFAULT_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldNotBeFound("ban_codigobancario.doesNotContain=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the agenciabancariaList where ban_codigobancario does not contain UPDATED_BAN_CODIGOBANCARIO
        defaultAgenciabancariaShouldBeFound("ban_codigobancario.doesNotContain=" + UPDATED_BAN_CODIGOBANCARIO);
    }
    ...
    public void updateAgenciabancaria() throws Exception {
        ...
        assertThat(testAgenciabancaria.getBan_codigobancario()).isEqualTo(UPDATED_BAN_CODIGOBANCARIO);
    }
