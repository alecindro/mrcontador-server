...
public class BancoResourceIT {
    ...
    private static final Integer DEFAULT_BAN_CODIGOBANCARIO = 1;
    private static final Integer UPDATED_BAN_CODIGOBANCARIO = 2;
    private static final Integer SMALLER_BAN_CODIGOBANCARIO = 1 - 1;
    ...
    @Test
    @Transactional
    public void getAllBancosByBan_codigobancarioIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bancoRepository.saveAndFlush(banco);

        // Get all the bancoList where ban_codigobancario is greater than or equal to DEFAULT_BAN_CODIGOBANCARIO
        defaultBancoShouldBeFound("ban_codigobancario.greaterThanOrEqual=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the bancoList where ban_codigobancario is greater than or equal to UPDATED_BAN_CODIGOBANCARIO
        defaultBancoShouldNotBeFound("ban_codigobancario.greaterThanOrEqual=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllBancosByBan_codigobancarioIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        bancoRepository.saveAndFlush(banco);

        // Get all the bancoList where ban_codigobancario is less than or equal to DEFAULT_BAN_CODIGOBANCARIO
        defaultBancoShouldBeFound("ban_codigobancario.lessThanOrEqual=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the bancoList where ban_codigobancario is less than or equal to SMALLER_BAN_CODIGOBANCARIO
        defaultBancoShouldNotBeFound("ban_codigobancario.lessThanOrEqual=" + SMALLER_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllBancosByBan_codigobancarioIsLessThanSomething() throws Exception {
        // Initialize the database
        bancoRepository.saveAndFlush(banco);

        // Get all the bancoList where ban_codigobancario is less than DEFAULT_BAN_CODIGOBANCARIO
        defaultBancoShouldNotBeFound("ban_codigobancario.lessThan=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the bancoList where ban_codigobancario is less than UPDATED_BAN_CODIGOBANCARIO
        defaultBancoShouldBeFound("ban_codigobancario.lessThan=" + UPDATED_BAN_CODIGOBANCARIO);
    }

    @Test
    @Transactional
    public void getAllBancosByBan_codigobancarioIsGreaterThanSomething() throws Exception {
        // Initialize the database
        bancoRepository.saveAndFlush(banco);

        // Get all the bancoList where ban_codigobancario is greater than DEFAULT_BAN_CODIGOBANCARIO
        defaultBancoShouldNotBeFound("ban_codigobancario.greaterThan=" + DEFAULT_BAN_CODIGOBANCARIO);

        // Get all the bancoList where ban_codigobancario is greater than SMALLER_BAN_CODIGOBANCARIO
        defaultBancoShouldBeFound("ban_codigobancario.greaterThan=" + SMALLER_BAN_CODIGOBANCARIO);
    }
