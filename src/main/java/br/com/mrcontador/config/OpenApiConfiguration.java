...
@Configuration
@Profile(value = {JHipsterConstants.SPRING_PROFILE_SWAGGER, JHipsterConstants.SPRING_PROFILE_PRODUCTION})
public class OpenApiConfiguration {

    @Bean
    public SwaggerCustomizer noApiFirstCustomizer() {
        return docket -> docket.select()
            .apis(Predicates.not(RequestHandlerSelectors.basePackage("br.com.mrcontador.web.api")));
    }
    ...
    public Docket apiFirstDocket(JHipsterProperties jHipsterProperties) {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .select()
            .apis(RequestHandlerSelectors.basePackage("br.com.mrcontador.web.api"))
