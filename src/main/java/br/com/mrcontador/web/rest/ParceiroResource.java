...
public class ParceiroResource {
    ...
    public ResponseEntity<ParceiroDTO> createParceiro(@Valid @RequestBody ParceiroDTO parceiroDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/parceiros/" + result.getId()))
    ...
    public ResponseEntity<ParceiroDTO> updateParceiro(@Valid @RequestBody ParceiroDTO parceiroDTO) throws URISyntaxException {
