...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(br.com.mrcontador.service.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    @ExceptionHandler
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(br.com.mrcontador.service.UsernameAlreadyUsedException ex, NativeWebRequest request) {
