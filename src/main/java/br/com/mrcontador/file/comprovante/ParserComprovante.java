...
public interface ParserComprovante {
	...
	void callFunction(List<Comprovante> comprovantes, ComprovanteService service, ExtratoService extratoService);
	List<PPDocumentDTO> parseComprovante(FileDTO fileDTO);
