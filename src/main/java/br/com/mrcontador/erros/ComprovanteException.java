...
public class ComprovanteException extends AbstractThrowableProblem{
	
	private static final long serialVersionUID = 1L;
	private String errorKey;
	private String defaultMessasge;
	
	public ComprovanteException(String errorKey, String message, Throwable e) {
		 this(errorKey,message);
		this.defaultMessasge = message;
		this.errorKey = errorKey;
	}
	
	public ComprovanteException(String errorKey, Throwable e) {
		this(errorKey,errorKey);
     	this.errorKey = errorKey;
	}
	
	public ComprovanteException(String errorKey, String message) {
		 super(ErrorConstants.MR_CONTADOR_TYPE, message, Status.BAD_REQUEST, null, null, null, getAlertParameters(message, errorKey));
		this.defaultMessasge = message;
		this.errorKey = errorKey;
	}
	
	public ComprovanteException(String errorKey) {
		this(errorKey,errorKey);
     	this.errorKey = errorKey;
	}
