CREATE OR REPLACE FUNCTION ds_demo.extrato_functionunicred("pEXT_CODIGO" bigint, "pAG_CODIGO" bigint)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN 
 ...
 SELECT   a.PARCEIRO_ID, a.BANCO_ID, a.AGE_AGENCIA, a.AGE_NUMERO INTO vPARCEIROID, vBANCOID, vAGEAGENCIA, vAGENUMERO from ds_demo.AGENCIABANCARIA a where a.ID = pAG_CODIGO AND a.TIPO_AGENCIA = 'CONTA';
