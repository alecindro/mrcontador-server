...
insert into ${schema}.jhi_authority values('ROLE_ADMIN'),('ROLE_USER'),('ds_mrcontador');
...
insert into ${schema}.jhi_user_authority values(2,'ROLE_ADMIN'),(2,'ROLE_USER'),(2,'ds_mrcontador');
